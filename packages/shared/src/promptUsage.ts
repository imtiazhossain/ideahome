...
export function buildShareablePromptCoachTemplate(): string {
  return [
    ...
    "2. One overall score out of 100.",
    "3. A score breakdown for brevity, output efficiency, redundancy control, and instruction density.",
    "4. The top improvement priorities based on the most common issues across the prompts.",
    "",
