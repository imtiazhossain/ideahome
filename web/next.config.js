...
const API_REWRITE_HAS = [
  { type: "header", key: "X-Ideahome-Api", value: "1" },
];
  ...
  async rewrites() {
    ...
    if (useBuiltinApi) {
      return [
        ...
        { source: "/tests/:path*", destination: "/api/tests/:path*", has: API_REWRITE_HAS },
        ...
        { source: "/ideas/:path*", destination: "/api/ideas/:path*", has: API_REWRITE_HAS },
        { source: "/bugs", destination: "/api/bugs", has: API_REWRITE_HAS },
        { source: "/bugs/:path*", destination: "/api/bugs/:path*", has: API_REWRITE_HAS },
        { source: "/features", destination: "/api/features", has: API_REWRITE_HAS },
        { source: "/features/:path*", destination: "/api/features/:path*", has: API_REWRITE_HAS },
        { source: "/expenses", destination: "/api/expenses", has: API_REWRITE_HAS },
        { source: "/expenses/:path*", destination: "/api/expenses/:path*", has: API_REWRITE_HAS },
      ];
    }
    ...
    return [
      ...
      { source: "/tests/:path*", destination: `${backend}/tests/:path*`, has: API_REWRITE_HAS },
      { source: "/tests", destination: `${backend}/tests`, has: API_REWRITE_HAS },
      ...
      { source: "/ideas", destination: `${backend}/ideas`, has: API_REWRITE_HAS },
      { source: "/ideas/:path*", destination: `${backend}/ideas/:path*`, has: API_REWRITE_HAS },
      { source: "/bugs", destination: `${backend}/bugs`, has: API_REWRITE_HAS },
      { source: "/bugs/:path*", destination: `${backend}/bugs/:path*`, has: API_REWRITE_HAS },
      { source: "/features", destination: `${backend}/features`, has: API_REWRITE_HAS },
      { source: "/features/:path*", destination: `${backend}/features/:path*`, has: API_REWRITE_HAS },
      { source: "/expenses", destination: `${backend}/expenses`, has: API_REWRITE_HAS },
      { source: "/expenses/:path*", destination: `${backend}/expenses/:path*`, has: API_REWRITE_HAS },
    ];
  },
